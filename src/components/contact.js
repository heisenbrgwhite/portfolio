  ...
  return (
    <div className=" w-full text-center mt-10 pt-36 pb-10 bg-transparent" id="contactme">
      ...
      <a href="mailto:me.sarkar099@outlook.com">
        <span className="mt-10 inline-block w-auto bg-black font-display text-white text-base md:text-xl py-4 px-7 cursor-pointer hover:bg-slate-300 hover:text-black">
